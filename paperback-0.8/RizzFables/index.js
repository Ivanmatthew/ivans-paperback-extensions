...
},{"./load.js":75,"./parse.js":77,"./parsers/parse5-adapter.js":78,"./static.js":79,"./types.js":80,"dom-serializer":97,"htmlparser2":123}],75:[function(require,module,exports){
"use strict";
...
},{"domhandler":99,"parse5":135,"parse5-htmlparser2-tree-adapter":128}],79:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"./named-references":118,"./numeric-unicode-map":119,"./surrogate-pairs":120}],118:[function(require,module,exports){
...
},{"./Tokenizer.js":122,"entities/lib/decode.js":109}],122:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"entities/lib/decode.js":109}],123:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
},{"./Parser.js":121,"./Tokenizer.js":122,"domelementtype":98,"domhandler":99,"domutils":103}],124:[function(require,module,exports){
...
},{"domhandler":99,"parse5":135}],129:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../common/html.js":132,"../tree-adapters/default.js":142,"entities/lib/escape.js":112}],140:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../common/error-codes.js":130,"../common/html.js":132,"../common/token.js":133,"../common/unicode.js":134,"./preprocessor.js":141,"entities/lib/decode.js":109}],141:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.RizzFables = exports.RizzFablesInfo = void 0;
const types_1 = require("@paperback/types");
const RizzFablesParser_1 = require("./RizzFablesParser");
const UrlBuilder_1 = require("../UrlBuilder");
const cheerio = __importStar(require("cheerio"));
const SourceRequestManager_1 = require("./components/SourceRequestManager");
...
class RizzFables extends Configuration_1.Configuration {
    constructor() {
        ...
        this.parser = new RizzFablesParser_1.MangaStreamParser();
        this.requestManager = (0, SourceRequestManager_1.getSourceRequestManager)(RizzFables.baseUrl);
    ...
    async constructSearchRequest(page, query) {
        let searchUrl = new UrlBuilder_1.URLBuilder(RizzFables.baseUrl);
        const headers = {
        ...
        if (query?.title) {
            ...
            const statusValue = (0, Helper_1.getIncludedTagBySection)('status', query?.includedTags);
            const typeValue = (0, Helper_1.getIncludedTagBySection)('type', query?.includedTags);
            const orderValue = (0, Helper_1.getIncludedTagBySection)('order', query?.includedTags);
            formData['genres_checked[]'] = (0, Helper_1.getFilterTagsBySection)('genres', query?.includedTags, true).join('&genre[]=');
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        switch (homepageSectionId) {
            ...
            default: {
                ...
                // @ts-ignore
                this.homescreen_sections[homepageSectionId].getViewMoreItemsFunc(page) ?? undefined;
                if (!param) {
...
exports.RizzFables = RizzFables;

},{"../UrlBuilder":150,"./RizzFablesParser":144,"./components/Configuration":145,"./components/Helper":146,"./components/SourceRequestManager":148,"./components/Types":149,"@paperback/types":61,"cheerio":74}],144:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class MangaStreamParser {
    ...
    parseMangaDetails($, mangaTitle) {
        ...
        const cleanedDescription = (0, html_entities_1.decode)(description)
    ...
    async parseHomeSection($, section, sourceInstance) {
        const items = [];
...
},{"./components/Configuration":145,"./components/Helper":146,"./components/LanguageUtils":147,"html-entities":117}],145:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
 ...
 */
Configuration.baseUrl = 'https://rizzfables.com';
/**
 ...
 * Default = "manga"
 */
Configuration.directoryPath = 'series';
/**
 * The pathname between the domain and the filter path. (Usually the same but can deviate)
 */
Configuration.filterPath = 'series';
Configuration.filterEndpoint = 'Index/filter_series';
Configuration.searchEndpoint = 'Index/live_search';
/**
 ...
 */
Configuration.manga_selector_AlternativeTitles = 'Alternative Titles';
/**
 ...
 */
Configuration.manga_selector_author = 'Author';
/**
 ...
 */
Configuration.manga_selector_artist = 'Artist';
/**
...
*/
Configuration.manga_selector_status = 'Status';
//----MANGA TAG SELECTORS----
Configuration.manga_tag_selector_box = 'span.mgen';
// ----STATUS SELECTORS----
/**
 ...
 */
Configuration.manga_StatusTypes = {
    ONGOING: 'ONGOING',
    COMPLETED: 'COMPLETED'
};
// ----DATE SELECTORS----
...
},{"@paperback/types":61}],147:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../components/Configuration":145}],148:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.getSourceRequestManager = void 0;
const getSourceRequestManager = (sourceUrl) => {
...
exports.getSourceRequestManager = getSourceRequestManager;
...
class URLBuilder {
    ...
    build({ addTrailingSlash, includeUndefinedParameters } = defaultBuildParameters) {
